          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  You agree that by accessing the website and/or services, you have read, understood, and agree to be
                  bound by all of these Terms of Service. If you do not agree with all of these Terms of Service, then
                  you are expressly prohibited from using the website and/or services and you must discontinue use
                  immediately.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  the website (collectively, the "Content") and the trademarks, service marks, and logos contained
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold tracking-tight">User Representations</h2>
                <p className="text-muted-foreground">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  You may not access or use the website or services for any purpose other than that for which we make
                  them available. The website and services may not be used in connection with any commercial endeavors
                  except those that are specifically endorsed or approved by us.
                </p>
                <p className="text-muted-foreground">As a user of the website or services, you agree not to:</p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>
