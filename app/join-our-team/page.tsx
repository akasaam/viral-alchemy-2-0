...
export default function JoinOurTeam() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/917501411769?text=${encodeURIComponent(message)}`, "_blank")
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Be part of a creative, innovative team that's transforming the digital marketing landscape.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  We're more than just a digital marketing agency. We're a family of creative minds and strategic
                  thinkers.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <CardWithTruncate className="h-[400px] flex flex-col w-full">
                <CardHeader>
                  ...
                  <CardDescription>We invest in your professional development and career growth.</CardDescription>
                </CardHeader>
              ...
              <CardWithTruncate className="h-[400px] flex flex-col w-full">
                <CardHeader>
                  ...
                  <CardDescription>
                    We foster a supportive environment where everyone's ideas are valued.
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex-grow">
                  <ul className="grid gap-2">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <TextReveal text="Open Positions" className="text-3xl font-bold tracking-tighter md:text-4xl/tight" />
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  Join our team of talented professionals and help us create digital marketing magic.
                </p>
              </div>
            </div>
            <div className="mx-auto max-w-5xl py-12 space-y-6">
              <Card className="overflow-hidden w-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We're looking for an experienced digital marketing specialist to lead campaigns and develop
                    strategies for our clients. The ideal candidate has 3+ years of experience in digital marketing with
                    a strong background in SEO, PPC, and social media marketing.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card className="overflow-hidden w-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We're seeking a talented web developer to join our growing team. The ideal candidate has experience
                    with modern web technologies including React, Next.js, and responsive design principles. You'll be
                    responsible for building beautiful, functional websites for our clients.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600">
              ...
              <Card className="overflow-hidden w-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We're looking for a creative content writer with a passion for digital marketing. The ideal
                    candidate has excellent writing skills, SEO knowledge, and the ability to create engaging content
                    across various industries. You'll be responsible for blog posts, social media content, and website
                    copy.
                  </p>
                </CardContent>
                <CardFooter>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                />
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  Don't see a position that fits your skills? We're always looking for talented individuals to join our
                  team.
                </p>
              </div>
            </div>
                  ...
                  <form className="grid gap-4" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Your resume will be sent via WhatsApp after form submission.
                      </p>
                    </div>
                    <Button
                      type="submit"
