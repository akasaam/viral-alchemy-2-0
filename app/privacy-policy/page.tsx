            ...
            <div className="mx-auto max-w-3xl space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  viral alchemy ("we", "our", or "us") is committed to
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  address, telephone number, and other similar information that
                  you voluntarily provide to us when you register with the
                  website or when you choose to contact us.
                </p>
                ...
                <p className="text-muted-foreground">
                  ...
                  device, if you access the website from a mobile device.
                </p>
                ...
                <p className="text-muted-foreground">
                  ...
                  exchange, or request information about our services.
                </p>
                ...
                <p className="text-muted-foreground">
                  ...
                  website and improve your experience. For more information on
                  how we use cookies, please refer to our Cookie Policy section
                  below.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Personalize your website experience and deliver content and
                  ...
                  <li>
                    ...
                    to the website more personalized.
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Contacting you for market research purposes to better
                    understand your needs and preferences.
                  </li>
                  <li>
                    Customizing the website according to your interests and
                    browsing behavior.
                  </li>
                  <li>
                    Delivering personalized advertisements based on your
                    interests and online activities.
                  </li>
                  <li>
                    Measuring the effectiveness of our marketing campaigns and
                    improving our marketing strategies.
                  </li>
                  <li>
                    Creating lookalike audiences for advertising purposes on
                    third-party platforms.
                  </li>
                  <li>
                    Retargeting you with advertisements after you've visited our
                    website.
                  </li>
                </ul>
                <p className="text-muted-foreground">
                  You have the right to opt-out of receiving marketing
                  communications from us at any time. You can exercise this
                  right by clicking on the "unsubscribe" or "opt-out" link in
                  the marketing emails we send you, or by contacting us using
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  We may share your information with advertising partners who
                  may use technologies such as cookies to gather information
                  about your activities on our website and other sites to
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  personalize content. By using our website, you consent to our
                ...
                <p className="text-muted-foreground">
                  We also provide a cookie consent banner that allows you to
